...
def ResultSfric(model="", result="", sfric='', deformed=1, ht=8.0E-03, sfht=1.0E-03, contact = False):
    ...
    for sf in srf:
        ...
        if ex ==0:
            ...
            sfric.pSurface.Surface.append([sf[0], sf[1], sf[2], sf[3], sf[4], coord])
    print ("No. of contact surface %d"%(len(sfric.pSurface.Surface)))
